...
class RPCClient(object):
    ...
    :param transport: A :py:class:`~tinyrpc.transports.ClientTransport`
                      instance.
    :param retries: int, number of retries for rpc in case of timeout`
                      retries=0 means no retry, which is default.
    """

    def __init__(self, protocol, transport, publisher, retries=0):
    ...
    def send_and_handle_reply_blocking(self, req):
        ...
        # total cycle; retries==0 means no retry.
        cycle = 1 + self.retries
